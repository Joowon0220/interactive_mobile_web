...
function setPageUrl (hostUrl, callback) {
	function Page (hostUrl) {
	    ...
	    this.alreadySendTime = false;
	    this.alreadySendSubTime = false;
	}
	...
	Page.prototype.exitPage = function () {
		if (this.prevPageId && !this.alreadySendTime) {
			this.alreadySendTime = true;
			var currentTime = (new Date()).getTime();
			var time = currentTime - this.prevTime;
			console.log(time);
	...
	Page.prototype.exitSubPage = function () {
		if (this.prevSubPageId && this.prevSubPageTime && !this.alreadySendSubTime) {
			this.alreadySendSubTim = true;
			var currentTime = (new Date()).getTime();
